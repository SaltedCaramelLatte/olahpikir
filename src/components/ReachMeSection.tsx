...
const ReachMeSection: React.FC<ReachMeSectionProps> = ({
    contacts = [] // Empty array if no contacts are provided
}) => {
    const [isOpen, setIsOpen] = useState(false);
                            ...
                            <div className="flex space-x-6 justify-center">
                                {contacts.map((contact, index) => (
                                    <a
                                        ...
                                        className={`${contact.colorClass} text-4xl hover:text-light-primary dark:hover:text-dark-primary transition`}
                                    >
                                        {contact.icon}
                                    </a>
                                ))}
